...
Architecture consistency and compliance audits. Migrated from `docs/audit/`
(pluralized). Only audits that were actually performed are listed — no
historical audits are fabricated.
